(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/battle/component/player/AI/AIMgr.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '978a9hGBgpJlKAyE0XGAAwZ', 'AIMgr', __filename);
// scripts/battle/component/player/AI/AIMgr.js
...
var ConditionCfg = [[true, false, 0.5, false, 0, false, false, 0, false, true, true, true, 2, false, false, true, 0], [true, false, 0.5, false, 0.5, false, false, 0, false, true, true, true, 2, false, false, true, 0], [true, false, 0.5, false, 0.5, true, true, 12, true, true, true, true, 2, false, false, true, 0], [false, true, 0.5, false, 2.0, true, true, 18, true, false, false, true, 2, false, false, true, 0], [false, true, 0.5, true, 2.0, true, true, 24, true, false, false, true, 2, true, false, true, 1], [false, true, 0.5, true, 2.5, true, true, 30, true, false, false, true, 3, true, true, true, 1], [false, true, 0.5, true, 3.0, true, true, 36, true, false, false, false, 4, true, true, false, 1]];
var FreshProtect = [[[2, 2, 2, 3, 4, 5], [0.01, 0.01, 0.01], [true, true, true]], [[3, 3, 3, 4, 5, 6], [0.01, 0.01, 0.01], [true, true, true]], [[5, 5, 5, 6, 7, 8], [0.01, 0.01, 0.01], [true, true, true]], [[6, 6, 6, 7, 8, 9], [0.01, 0.01, 0.01], [true, true, true]], [[8, 8, 8, 9, 10, 11], [0.01, 0.01, 0.01], [true, true, false]], [[9, 9, 9, 10, 11, 12], [0.01, 0.01, 0.01], [true, true, false]], [[10, 10, 10, 11, 12, 13], [0.01, 0.01, 0.01], [true, true, false]]];

var Tools = require('Tools');
var ConfigData = require('ConfigData');
var PlayerData = require('PlayerData');
var AICfgType = require('Types').AICfgType;
var GameData = require('GameData');
var AIFreshCfgType = require('Types').AIFreshCfgType;
...
var AIMgr = cc.Class({
     ...
     * @param {*} defenceTime 
     */
    init: function init(moveSpeed, level, entityPlayer) {
        ...
        var cfg = ConditionCfg[level];
        var freshCfg = FreshProtect[level];
        ...
        var freshToward = !freshCfg[AIFreshCfgType.removeToward] || !freshCfg[AIFreshCfgType.removeToward][PlayerData.instance.playCount];
    ...
    _doOneTimeCondition: function _doOneTimeCondition() {
    ...
    _switchCurAction: function _switchCurAction(dt) {
    ...
    _updateCurAction: function _updateCurAction(dt) {
        if (this._curAction) {
            this._curAction.updateGameLogic(dt);
        }
    },

    _checkNextAction: function _checkNextAction(dt) {
        if (this._curAction) {
    ...
    addNearOther: function addNearOther(other) {
        if (other.isLocal) {
    ...
    leaveOther: function leaveOther(other) {
        if (other.isLocal) {
            if (this._conditionInThenOutLocalHero) {
    ...
    addNearBlock: function addNearBlock(block) {
        if (this._conditionNearBlock) {
            this._conditionNearBlock.doResultWithParam(block);
        }
    },

    addNearKnife: function addNearKnife(knife) {
    ...
    getNoMoreKnifeNum: function getNoMoreKnifeNum() {
    ...
    getReviveTotal: function getReviveTotal() {
