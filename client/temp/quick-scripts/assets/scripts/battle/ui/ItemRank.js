(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/battle/ui/ItemRank.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '0682dTnQ4FHn4QwYe8hK6wM', 'ItemRank', __filename);
// scripts/battle/ui/ItemRank.js
...
cc.Class({
    ...
    init: function init(data, isAchieve, isKeep) {
        this.data = data;
        this.isKeep = isKeep;
        var str = data.name;
    ...
    refreshUnlock: function refreshUnlock(data) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=ItemRank.js.map
