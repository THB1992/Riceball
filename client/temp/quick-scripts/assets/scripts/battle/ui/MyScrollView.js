(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/battle/ui/MyScrollView.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '849f47bO/tNYoqEQiVMrfzo', 'MyScrollView', __filename);
// scripts/battle/ui/MyScrollView.js
...
cc.Class({
     ...
     */
    init: function init(datas, params, callback) {
        this.datas = datas;
    ...
    onScrollView: function onScrollView(event) {
    ...
    scrollToRank: function scrollToRank(rank, time) {
        this.lastLine = -1;
    ...
    refresh: function refresh(datas) {
        this.datas = datas;
        this.datasLength = datas.length;
        this.maxLine = Math.ceil(this.datasLength / this.perLine);
        this.srollview.content.height = this.itemHeight * this.maxLine;
        for (var i = 0; i < this.datasLength; i++) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=MyScrollView.js.map
