(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/battle/ui/PanelReward.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '5629dI6NRFOM4jqdZJQmtzo', 'PanelReward', __filename);
// scripts/battle/ui/PanelReward.js
...
cc.Class({
    ...
    init: function init(data, callback, errCallback, world) {
        var _this = this;
        ...
        if (this.isSpecial) {
            ...
            for (var i = 0; i < this.shadowNode.children.length; i++) {
        ...
        if (data.suit) {
            ...
            this.openSuitCallback = function () {
                if (isHeroSkin) {
                    _this.world.onEquipKnifeSkin(knifeData, true);
                } else {
                    _this.world.onEquipHeroSkin(heroData, true);
                }
            };
        }
    ...
    openSuitBtnClick: function openSuitBtnClick() {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=PanelReward.js.map
