(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/common/AdvertMgr.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '36a96U5S9hH5qhkQLhkfp09', 'AdvertMgr', __filename);
// scripts/common/AdvertMgr.js
...
var AdvertMgr = cc.Class({
    statics: {
        ...
        normalAdverCallBack: function normalAdverCallBack(result) {
        ...
        errorAdverCallBack: function errorAdverCallBack() {
            AdvertMgr.instance.isShowAdvert = false;
        ...
        //开屏广告回调
        oepnAdCallBack: function oepnAdCallBack(result) {
        ...
        //每日上报回调
        onTotalAdsRevenueCallBack: function onTotalAdsRevenueCallBack(revenue) {
        ...
        //链接bitverse钱包结果
        onBitVerseConnectCallBack: function onBitVerseConnectCallBack(adress) {
    ...
    showUITips: function showUITips(str) {
        this.uiMgr.showTips(str);
    },

    loadAdver: function loadAdver(adId, callback) {
        switch (PlatformMgr.platformType) {
     ...
     * @param {*} adId 
     */
    openAdver: function openAdver(adId) {
        PlatformMgr.hawkeye_report_advert_open(adId);
    },

    showAdver: function showAdver(adId, closeCallback, errCallback) {
        var _this = this;
            ...
            case PlatformType.WECHAT:
                {
                    ...
                    var video1 = this.adverPool[adId];
                    var hasLoad = false;
                    if (video1) {
            ...
            case PlatformType.ANDROID:
                {
                    ...
                    switch (PlatformMgr.channelType) {
                        case ChannelType.RiceBall:
                            jsb.reflection.callStaticMethod("org/cocos2dx/javascript/activity/UpltvAdverManager", "showAd", "(Ljava/lang/String;)V", adUnitId);
                            break;
                        case ChannelType.RiceBall_1:
                            jsb.reflection.callStaticMethod("org/cocos2dx/javascript/activity/AdTimingAdverManager", "showAd", "()V");
                            break;
                        case ChannelType.RiceBall_2:
                            jsb.reflection.callStaticMethod("org/cocos2dx/javascript/AdManage", "showRewardVideoAd", "(Ljava/lang/String;)V", adUnitId);
                            break;
                    }
                    PlatformMgr.hawkeye_report_advert_show(adId);
                }
    ...
    destoryBanner: function destoryBanner() {
        // return;
        switch (PlatformMgr.platformType) {
            case PlatformType.WECHAT:
                {
    ...
    destroyOpenApp: function destroyOpenApp() {
        switch (PlatformMgr.platformType) {
            case PlatformType.ANDROID:
                switch (PlatformMgr.channelType) {
                    case ChannelType.RiceBall:
    ...
    loadOpenApp: function loadOpenApp() {
        switch (PlatformMgr.platformType) {
            case PlatformType.ANDROID:
                switch (PlatformMgr.channelType) {
                    case ChannelType.RiceBall:
    ...
    fireBaseEvent: function fireBaseEvent(event) {
        ...
        switch (PlatformMgr.platformType) {
            case PlatformType.ANDROID:
                switch (PlatformMgr.channelType) {
                    ...
                    case ChannelType.RiceBall_2:
                        if (key && value) {
                            jsb.reflection.callStaticMethod("org/cocos2dx/javascript/AdManage", "FAEventWithParam", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", event, key, value);
                        } else {
                            jsb.reflection.callStaticMethod("org/cocos2dx/javascript/AdManage", "FAEvent", "(Ljava/lang/String;)V", event);
                        }
                        break;
                }
                break;
    ...
    //冷启动开屏广告
    getOpenAdRules: function getOpenAdRules() {
        switch (PlatformMgr.platformType) {
            case PlatformType.ANDROID:
                switch (PlatformMgr.channelType) {
                    case ChannelType.RiceBall:
...
cc._RF.pop();
        ...
        //# sourceMappingURL=AdvertMgr.js.map
