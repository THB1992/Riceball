(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/common/Launcher.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ecdd80fvmFNM7J2vtfZV6KB', 'Launcher', __filename);
// scripts/common/Launcher.js
...
var UpdateMgr = require('UpdateMgr');
...
var v2Proto = cc.Vec2.prototype;
var PayMgr = require('PayMgr');

/**
 * Launcher 游戏入口
 */
var Launcher = cc.Class({
    ...
    init: function init() {
        ...
        UpdateMgr.checkNewClient(function () {
        ...
        var setRotation = function setRotation(value) {
            this.angle = -value;
        };
            ...
            if (PlayerData.instance.loadComplete) {
                if (!this.isloading) {
                    ...
                    if (PlatformMgr.platformType == PlatformType.ANDROID) {
                        ...
                        //是否是第一天的用户
                        var frst = PlayerData.instance.isFirstDay() ? "1" : "0";
                        jsb.reflection.callStaticMethod("org/cocos2dx/javascript/AdManage", "FAUserProperty", "(Ljava/lang/String;Ljava/lang/String;)V", "is_firstopen", frst);

                        //同步每日广告收益
                        jsb.reflection.callStaticMethod("org/cocos2dx/javascript/AdManage", "FATotalRevenueSwitch", "(Ljava/lang/String;Ljava/lang/String;)V", PlayerData.instance.dayCanReportTotalAdsRevenue ? "1" : "0", PlayerData.instance.dayTotalAdsRevenue + "");

                        //测试，随机ab——test
                        jsb.reflection.callStaticMethod("org/cocos2dx/javascript/AdManage", "FAUserProperty", "(Ljava/lang/String;Ljava/lang/String;)V", "ab_test", Math.random() > 0.5 ? "1.0.37_A" : "1.0.37_B");
                    } else if (PlatformMgr.platformType == PlatformType.IOS) {
                        var _frst = PlayerData.instance.isFirstDay() ? "1" : "0";
                        jsb.reflection.callStaticMethod("AdManage", "FAUserProperty:sec:", "is_firstopen", _frst);

                        //同步每日广告收益
                        jsb.reflection.callStaticMethod("AdManage", "FATotalRevenueSwitch:sec:", PlayerData.instance.dayCanReportTotalAdsRevenue ? "1" : "0", PlayerData.instance.dayTotalAdsRevenue + "");
                    }
