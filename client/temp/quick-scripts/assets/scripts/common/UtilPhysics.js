(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/common/UtilPhysics.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'c284aJZaxNHpLTQ9LR7Uvfw', 'UtilPhysics', __filename);
// scripts/common/UtilPhysics.js
...
var UtilPhysics = cc.Class({
    statics: {
         ...
         */
        checkPointLine: function checkPointLine(x, y, p1, p2) {
         ...
         * @param r 矩形
         */
        isCollidingLineRect: function isCollidingLineRect(p1, p2, r) {
            // 判断2点是否和矩形碰撞
        ...
        isCollidingRectRect: function isCollidingRectRect(r1, r2) {
            return Math.abs(r2.x - r1.x) * 2 <= r1.width + r2.width && Math.abs(r2.y - r1.y) * 2 <= r1.height + r2.height;
        },

        isCollidingRectPoint: function isCollidingRectPoint(rect, point) {
        ...
        checkMovePointCollideRectReturnHitPos: function checkMovePointCollideRectReturnHitPos(pointPos, dir, rect, isKeepOutOfRect) {
        ...
        checkMoveRectCollideRectReturnHitPos: function checkMoveRectCollideRectReturnHitPos(moveRect, dir, rect, isKeepOutOfRect) {
        ...
        checkMovePointCollideRectReturnSlidePos: function checkMovePointCollideRectReturnSlidePos(pointPos, dir, rect, isKeepOutOfRect) {
            var startPos = pointPos;
            var endPos = pointPos.add(dir);
            var isContainsEnd = UtilPhysics.isCollidingRectPoint(rect, endPos);
            if (!isKeepOutOfRect) {
        ...
        checkMoveRectCollideRectReturnSlidePos: function checkMoveRectCollideRectReturnSlidePos(moveRect, dir, rect, isKeepOutOfRect) {
            rect = cc.rect(rect.x - moveRect.width / 2, rect.y - moveRect.height / 2, rect.width + moveRect.width, rect.height + moveRect.height);
            return UtilPhysics.checkMovePointCollideRectReturnSlidePos(moveRect.center, dir, rect, isKeepOutOfRect);
        },

        vertexDirScaleAbs: function vertexDirScaleAbs(x, y, pos) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=UtilPhysics.js.map
